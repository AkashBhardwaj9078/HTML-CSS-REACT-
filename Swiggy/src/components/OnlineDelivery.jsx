...
function Online(){
    ...
    <div className="max-w-[1200px] mx-auto h-[20px] my-[20px] z-[900]">
       <div className="flex ">
          <div className="text-[25px] font-bold m-10vh left-0"> Top restaurant-chains in Jodhpur </div>
       </div>
